...
# Time Succes decompile : 2022-06-24 14:08:57.062664
...
def menu():
    ...
    os.system('clear')
    print logo
    print '\033[91;1mEnter Sim Code And + Any 2 Digit Without Space  \n[ex] (1787,1678,1908)\n\n Grameenphone : 17,13 \n Robi         : 18 \n Airtel       : 16 \n Banglalink   : 19,14 '
    try:
